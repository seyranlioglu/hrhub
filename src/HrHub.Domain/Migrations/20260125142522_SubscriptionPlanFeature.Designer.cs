...
namespace HrHub.Domain.Migrations
{
    ...
    [Migration("20260125142522_SubscriptionPlanFeature")]
    partial class SubscriptionPlanFeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HrHub.Domain.Entities.SqlDbEntities.Training", b =>
                {
                    ...
                    b.Property<long?>("OwnerCurrAccId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HrHub.Domain.Entities.SqlDbEntities.TrainingProcessRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HrHub.Domain.Entities.SqlDbEntities.TrainingProcessRequest", b =>
                {
                    ...
                    b.HasOne("HrHub.Domain.Entities.SqlDbEntities.TrainingStatus", "RequestStatus")
                        .WithMany()
                        .HasForeignKey("RequestStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HrHub.Domain.Entities.SqlDbEntities.User", "RequesterUser")
                        .WithMany()
                        .HasForeignKey("RequesterUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HrHub.Domain.Entities.SqlDbEntities.TrainingStatus", "TargetStatus")
                        .WithMany()
